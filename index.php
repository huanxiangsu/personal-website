...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-157993981-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
        gtag('config', 'UA-157993981-1');
    </script>
...
<div class="ui sidebar vertical inverted menu left overlay">
    ...
    <div class="item">
        ...
        <div class="menu">
            <a class="item ui-sub-item" href="<?php if ($_SERVER['HTTP_HOST'] == "web.cecs.pdx.edu"){echo "http://karanokara.com/xiang/blog";} else{echo "../blog/";} ?>" target="_blank">Blog<i class='fab fa-wordpress ui-sidebar-right-icon'></i></a>
                ...
                <ul class="nav navbar-nav navbar-right" id="myNav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="tab-link" href="<?php if ($_SERVER['HTTP_HOST'] == "web.cecs.pdx.edu"){echo "http://xiang.karanokara.com/blog";} else{echo "../blog/";} ?>" target="_blank">Blog</a></li>
